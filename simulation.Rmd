...
We create `y_hat` as a matrix with as many rows as we have different covariate scenarios. The number of columns is the number of simulations. Then we multiply our covariates with our betas in a loop where on loop iteration is one scenario.
```{r}
