...
**Simulation step 3:** **Simulation step 3:** Predict the outcome. We have set our covariates and we drawn our coefficients. This is all we need to predict y. Depending on the flavour of generalized liner model, y may have to be sent through a link function. In logistic regression we would send latent y trough the logit link function: $\frac{1}{1 + exp^{-y}}$ to get probabilities y is 1. Here, we ran a simple linear model so in linear algebra notation our prediction is simply $Y=X\beta$.
