...
Let's load 2 datasets into R using `read.csv()` and confirm that the `state` and `communityname` are present in each dataset. You can either directly load the dataset from the online source as shown in the code below. Alternatively, get `communities` [here](http://philippbroniecki.github.io/ML2017.io/data/communities.csv) and `communitties_employment` [here](http://philippbroniecki.github.io/ML2017.io/data/communities_employment.csv), place them in your working directory and then load them from your local source.

```{r}
# load the communities datasets
communities <- read.csv("http://philippbroniecki.github.io/ML2017.io/data/communities.csv")
communities_employment <- read.csv("http://philippbroniecki.github.io/ML2017.io/data/communities_employment.csv")
```
...
1. Load the immigration dataset [dataset](http://philippbroniecki.github.io/ML2017.io/data/communities_immig.csv)
...
unloadNamespace("mcmc")
unloadNamespace("stats4")
unloadNamespace("parallel")
unloadNamespace("nloptr")
unloadNamespace("Amelia")
unloadNamespace("minqa")
unloadNamespace("nnet")
unloadNamespace("miscTools")
```
